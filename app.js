...
class Simon{
    ...
    // Ejecuta una funcion cuando se preciona un boton
    buttonClick(value){
    ...
    // Pinta los botones cuando se esta mostrando la secuencia
    ...
    // Muestra la animacion y actualiza el Simon cuando el jugador gana
    gameWon(){
        this.display.startButton.disabled = false;
        this.blockedButtons = true;
